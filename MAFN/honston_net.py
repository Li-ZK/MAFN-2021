...
def model():
    ...
    # -----------------------------------Spectral feature extraction is finished---------------------------------------------------------
    ...
    VIS_SHAPE3 = Reshape((VIS_relu3._keras_shape[1] * VIS_relu3._keras_shape[2], VIS_relu3._keras_shape[4]))(VIS_relu3)
    ...
    VIS_conv4 = Conv3D(16, (16, 1, 1), padding='same', strides=(1),kernel_initializer='glorot_uniform',kernel_regularizer=l2(1e-4))(VIS_SHAPEall)
